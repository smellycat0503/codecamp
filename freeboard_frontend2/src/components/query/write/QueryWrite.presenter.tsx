      ...
      <PhotoWrapper>
        ...
        <MyPhoto__List>
          ...
          {props.myImg.map((data, index) => (
            <>
              <PreviewImg__Wrapper>
                <Img__Del__Button id={index} onClick={props.onClickdeleteImage}>
                  X
                </Img__Del__Button>
...
//         X
//       </Img__Del__Button>
//       <PreviewImg src={props.myImg[0]}></PreviewImg>
//     </PreviewImg__Wrapper>
//   </>
// )}
...
//         X
//       </Img__Del__Button>
//       <PreviewImg src={props.myImg[1]}></PreviewImg>
//     </PreviewImg__Wrapper>
//   </>
// )}
...
//         X
//       </Img__Del__Button>
//       <PreviewImg src={props.myImg[2]}></PreviewImg>
//     </PreviewImg__Wrapper>
//   </>
// )}

// {props.myImg.map((_, index) => (
//   <PhotoContent>
//     <Photo_Wrapper htmlFor="photo">
//       <div style={{fontSize: '20px'}}>+</div>upload
//       <PhotoInput
